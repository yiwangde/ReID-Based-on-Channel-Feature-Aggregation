...
import yaml
import math
from model import ft_net, ft_net_dense, ft_net_NAS, PCB, PCB_test, ft_resnest50, ft_resnest269, resneft50
...
if opt.use_dense:
    ...
    model_structure = ft_resnest50(len(class_names))
    
elif opt.use_resnest269:
    model_structure = ft_resnest269(len(class_names))
   
elif opt.use_resneft50:
        model_structure = resneft50(len(class_names))
